...
<div class="container-fluid">
	<div class="jumbotron">
		...
		<form action="<?= base_url('dosen/edit_profile') ?>?pesan=save" method="post">
			<div class="col-md-6">
				<div class="form-group">
					<input type="text" class="form-control" name="id" onkeypress="return angka(event)" value="<?= $user['nip'] ?>" disabled>
				</div>
				<div class="form-group">
					<label for="">Name</label>
					<input type="text" class="form-control" name="name" value="<?= $user['name_dosen'] ?>">
				</div>
				<div class="form-group">
