...
<div class="container-fluid">
	<div class="jumbotron">
		...
		<form action="<?= base_url('mahasiswa/edit_profile') ?>?pesan=save" method="post">
			<div class="col-md-6">
				<div class="form-group">
					<input type="text" class="form-control" name="id" onkeypress="return angka(event)" value="<?= $user['nim'] ?>" disabled>
				</div>
				<div class="form-group">
					<label for="">Name</label>
					<input type="text" class="form-control" name="name" value="<?= $user['name_mhs'] ?>">
				</div>
				<div class="form-group">
				...
				<a href="<?= base_url('mahasiswa/profile') ?>" class="btn btn-danger"><i class="fas fa-times mr-2"></i>Cancel</a>
			</div>
	</div>
</div>
</form>
