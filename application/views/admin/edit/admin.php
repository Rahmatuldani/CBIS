...
<div class="container-fluid">
	<div class="jumbotron">
		...
		<form action="<?= base_url('update/edit_admin') ?>?id_edit=<?= $edit['id_admin'] ?>" method="post">
			<div class="col-md-6">
				<div class="form-group">
					<input type="text" class="form-control" name="id" onkeypress="return angka(event)" value="<?= $edit['id_admin'] ?>" disabled>
					<?= form_error('id', '<small class="text-danger pl-3">', '</small>') ?>
				</div>
				<div class="form-group">
					<input type="text" class="form-control" name="name" value="<?= $edit['name_admin'] ?>">
