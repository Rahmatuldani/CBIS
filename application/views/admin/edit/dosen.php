...
<div class="container-fluid">
	<div class="jumbotron">
		<h1 class="mb-5">Edit Dosen</h1>
		<form action="<?= base_url('update/edit_dosen') ?>?id_edit=<?= $edit['nip'] ?>" method="post">
			<div class="col-md-6">
				<div class="form-group">
					<input type="text" class="form-control" name="id" onkeypress="return angka(event)" value="<?= $edit['nip'] ?>" disabled>
					<?= form_error('id', '<small class="text-danger pl-3">', '</small>') ?>
				</div>
				<div class="form-group">
					<input type="text" class="form-control" name="name" value="<?= $edit['name_dosen'] ?>">
